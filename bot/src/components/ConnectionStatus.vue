  ...
  <section class="connection-status">
    <div class="status-grid">
      <div class="status-item">
        ...
        <span class="status-value" :class="{ connected: wsStatus.isConnected }">
      ...
      <div class="status-item">
        ...
        <span
          class="status-value"
          :class="{ connected: apiStatus.isConnected }"
        >
          {{ apiStatus.isConnected ? '连接成功' : '未连接' }}
        </span>
      </div>
    </div>
  </section>
...
import { apiStatus } from '@/composables/useBinanceApi';
</script>
